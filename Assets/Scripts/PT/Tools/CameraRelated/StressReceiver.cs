...
namespace PT.Tools.CameraRelated
{
    public class StressReceiver : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (shake > 0)
            {
                ...
                /* In order to avoid affecting the transform current position and rotation each frame we Subtract the previous translation and rotation */
